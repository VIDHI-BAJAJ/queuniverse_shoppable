  ...
  return (
    <div style={{ padding: "20px", maxWidth: "600px" }}>
      ...
      <Form method="post">
        ...
        <div style={{ marginBottom: "16px" }}>
          <label style={{ display: "block", marginBottom: "6px" }}>Video URL (direct MP4)</label>
          <input name="source_url" type="url" required placeholder="https://example.com/video.mp4"
            style={{ width: "100%", padding: "8px", border: "1px solid #ddd", borderRadius: "4px" }} />
        </div>
        <button type="submit" disabled={isLoading}
          style={{ padding: "10px 24px", background: isLoading ? "#ccc" : "#008060", color: "white", border: "none", borderRadius: "6px", cursor: isLoading ? "not-allowed" : "pointer" }}>
